...
Get-AzRoleAssignment -SignInName <YOUR_SIGN_IN_NAME>

Get-AzRoleDefinition | where Id -EQ (Get-AzRoleAssignment -SignInName <YOUR_SIGN_IN_NAME>).RoleDefinitionId 

Get-AzRoleDefinition -Name "CloudAcademy Network Contributor"